    ...
    <div className="soloPageContent">
      ...
      <TextContainer
        ...
        text={["OUR POWERS is an entirely virtual workshop, so all sessions will be held over zoom. The topics covered for summer 2021 including the date of each session are as follows:",
          ...
          <ul><li>Faris is an intersectional LGBTIQ+/human rights activist based in Vienna, who oversees House of Guramayle’s activities in Austria. They are the co-host and creator of the Alen Show, which dismantles dishonest information about the Ethiopian LGBTIQ+ community one episode at a time. Faris is a computer science graduate and has worked as an IT expert with the INGO PSI-Ethiopia. They are also a Salzburg Global Seminar Fellow.

          <li>More information can be found <a href="https://houseofguramayle.org/our-story/">here</a>.</li></li></ul>
          </li>
          <li>
          <h3>Week 2</h3>
